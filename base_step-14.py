...
class ProcessingStep:
    ...
    #: False for a step whose output is not reproducible from the frame
    #: index alone — a live camera or grabber. Two runs of such a graph
    #: legitimately differ, so anything comparing runs (the parallel
    #: equivalence test, the benchmark) must not report that as a fault.
