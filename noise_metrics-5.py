...
from src.GUI.pipeline_editor.base_step import (
    ParamSpec, ProcessingStep, StatefulStep, register_step,
)
...
@register_step
class TemporalNoise(StatefulStep):
    ...
    # Welford updates the accumulators IN PLACE (self._mean += ...), so a
    # shallow snapshot would alias them and restore nothing.
    SNAPSHOT_DEEP = True
