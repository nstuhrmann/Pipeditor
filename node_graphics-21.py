...
class EdgeItem(QGraphicsPathItem):
    ...
    def update_path(self):
        ...
        if self.source_port.is_control or (
                self.target_port is not None and self.target_port.is_control):
            # Control ports sit on the BOTTOM edge, so both tangents point
            # downward and the edge loops underneath the nodes. A feedback
            # link therefore reads as a loop rather than as another
            # left-to-right connection — which is what it is.
