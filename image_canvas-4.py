...
class ZoomPanCanvas(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # External QActions appended to the right-click context menu —
        # lets the owning window (e.g. LivePreviewWindow's "Lock View")
        # live in the same menu instead of needing its own menu bar.
        self.context_actions: list = []
