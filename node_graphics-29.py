...
class EdgeItem(QGraphicsPathItem):
    ...
    def update_path(self):
        ...
        builder = {
            EDGE_STYLE_STRAIGHT: self._path_straight,
            EDGE_STYLE_ORTHOGONAL: self._path_orthogonal,
            EDGE_STYLE_ROUNDED: self._path_orthogonal,
        }.get(self.style, self._path_curved)
        rounded = self.style == EDGE_STYLE_ROUNDED
        if builder is self._path_orthogonal:
            self.setPath(builder(start, end, vertical, rounded))
        else:
            self.setPath(builder(start, end, vertical))
