...
# Amber means CONTROL everywhere on the canvas: control ports, control
# edges, and the control line under a node. Metadata is a separate
# channel and gets its own colour, or the two are indistinguishable.
META_TEXT_COLOR = "#4dd0e1"     # teal — travels forward with the frame
CONTROL_TEXT_COLOR = "#ffb74d"
