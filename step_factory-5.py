...
def step_from_function(func, name: str = None, category: str = "General",
    ...
    flags       any extra class attributes: KIND ("source" / "sink" /
                "metric"), EMITS_CONTROL, ACCEPTS_CONTROL,
                IS_SEQUENCE_AWARE, ...
    """
...
def step_from_class(cls, name: str = None, category: str = "General",
    ...
    # The wrapped object mutates itself internally and we cannot inspect
    # it, so a shallow copy of self._proc would only duplicate a pointer.
    namespace.setdefault("SNAPSHOT_DEEP", True)
