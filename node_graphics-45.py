...
# Port LABELS always use the port's type colour, never the unconnected
# fill: the label names the port, and dimming it would make an unwired
# input harder to read at exactly the moment you need to read it.
...
class PortItem(QGraphicsEllipseItem):
    ...
    def refresh_connection_state(self):
        ...
        self.setBrush(QBrush(QColor(
            PORT_UNCONNECTED_COLOR if unwired else self.type_color())))
        self.update()
